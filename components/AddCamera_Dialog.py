...
#         # Apply a dark purple background and ensure text is readable
#         self.setStyleSheet("""
#             QDialog { background-color: rgb(60,30,65); }
#             QLabel, QLineEdit, QDialogButtonBox QPushButton { color: white; }
#         """)
